...
const posts = [
  ...
  },
  {
    ...
    body: [
      ...
      `3. **Add llms.txt to your website.** It is a simple text file that summarizes your services for AI crawlers. The major AI search engines (OpenAI, Perplexity, Google AI Mode) are starting to honor it for citation decisions.`,
  ...
  },
  {
    ...
    body: [
      ...
      `Wix puts your content inside its own template wrappers. Google\'s crawler still indexes the text, but the schema markup that tells Google "this is a roofing service serving Houma, Louisiana" is either missing or generic. AI engines (Google AI Overviews, ChatGPT, Perplexity) lean even harder on schema than classic Google search does. A Wix site is essentially invisible to those crawlers as a specific Houma roofing business; it registers as another generic business website.`,
      `**What to do about it.**`,
      ...
      `**Third, if you rebuild, demand the foundations.** Schema markup on every page, a real sitemap.xml, robots.txt, and llms.txt at minimum. These are the four files that get your business cited by AI search engines.`,
