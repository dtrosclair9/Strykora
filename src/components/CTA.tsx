...
export default function CTA({
  heading = 'Stop losing leads to a slow website.',
  body = `Tell me about your business in 60 seconds. I'll send back a candid take and a fixed-price quote within 24 hours.`,
}: CTAProps) {
  return (
