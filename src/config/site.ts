...
export const caseStudies = [
  ...
  },
  {
    ...
    city: 'Gonzales + Houma, LA',
    headline: 'Two locations, two pipelines, one site',
    blurb: 'Multi-location build with a single contact form swapping endpoints by location so each shop gets its own lead pipeline without losing the unified brand.',
    metrics: [
      { label: 'Locations', value: '2' },
      { label: 'Lead routing', value: 'Per-location' },
      { label: 'Live at', value: 'all-outwindowtint.com' },
    ],
