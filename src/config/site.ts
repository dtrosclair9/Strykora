...
export const services = [
  ...
  },
  {
    ...
    short: 'Rank for the keywords that pay the bills — in your city, in your parish, in the new AI Overviews.',
    long: 'Strykora ranks Louisiana businesses for the searches their customers actually type, including the AI-Overview citations that are eating into classic blue-link clicks in 2026. Keyword research grounded in real local search data. On-page optimization that compounds. Monthly content and link work that pays for itself.',
    bullets: [
      'Local keyword research grounded in real Louisiana search data',
      'On-page SEO + schema tuned for AI Overview citation',
      'Monthly content + ethical link building',
      'Transparent reporting (you see every move, every month)',
